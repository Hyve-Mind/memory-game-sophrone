...
function App() {
  ...
  useEffect(() => {
    if (bestScore === 12) {
      window.confirm(
        "Congrats, you beat the game! (Press any button to restart)"
      );
  ...
  return (
    <div className="container">
      ...
      <div className="content">
        ...
        <div className="info">
          Tip: Get points by clicking a character but don't click the same
          character more than once. Score 12 points to beat the game
        </div>
      </div>

      <div className="footer">
        <a href="https://github.com/sophrone">
          <strong>sophrone</strong>
          &nbsp;
          <svg
            aria-hidden="true"
